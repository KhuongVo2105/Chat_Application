...
const IconHome = (props) => {
    const path_home_default = "M6 19h3.692v-5.884h4.616V19H18v-9l-6-4.538L6 10zm-1 1V9.5l7-5.288L19 9.5V20h-5.692v-5.884h-2.616V20zm7-7.77";
    return (
...
const IconSearch = (props) => {
    const pathData = "m19.485 20.154l-6.262-6.262q-.75.639-1.725.989t-1.96.35q-2.402 0-4.066-1.663T3.808 9.503T5.47 5.436t4.064-1.667t4.068 1.664T15.268 9.5q0 1.042-.369 2.017t-.97 1.668l6.262 6.261zM9.539 14.23q1.99 0 3.36-1.37t1.37-3.361t-1.37-3.36t-3.36-1.37t-3.361 1.37t-1.37 3.36t1.37 3.36t3.36 1.37";
...
const IconMessage = (props) => {
    ...
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} class="bi bi-chat" viewBox="0 0 16 16">
...
const IconUserProfile = (props) => {
    ...
    return (
        <TouchableOpacity className={`overflow-hidden flex flex-row justify-center items-center ${containerStyles}`}
            style={{
...
// Xuất các component
export { IconHome, IconSearch, IconCreateNewPost, IconHeart, IconMessage, IconUserProfile };
