...
const UserSuggestion = (props) => {
    return (
        <View className="w-36 border border-slate-200 shadow-inner rounded-lg p-3 items-center mx-1">
            ...
            <View className={`w-16 h-16 overflow-hidden flex flex-row justify-center items-center`}>
            ...
            <Text className="text-base font-semibold">{props.username ? props.username : "username"}</Text>
            <View className="h-10">
                <Text
